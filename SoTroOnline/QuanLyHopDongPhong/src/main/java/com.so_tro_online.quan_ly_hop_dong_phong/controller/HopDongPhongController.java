...
public class HopDongPhongController {
    ...
    public ResponseEntity<ApiResponse> getAllActivePaged(
            @RequestParam(defaultValue = "0") int page,
            @RequestParam(defaultValue = "6") int size) {
        return ResponseEntity.ok(new ApiResponse("success", hopDongPhongService.getAllHopDongPhongActivePaged(page, size)));
    }
