...
import com.so_tro_online.quan_ly_khach_thue.entity.repository.KhachThueRepository;
...
public class HopDongDichVuService implements IHopDongDichVu{
    ...
    public HopDongDichVuReponse updateHopDongDichVu(Integer id, HopDongDichVuRequest hopDongDichVuRequest) {
        ...
        boolean exists = hopDongDichVuRepository.existsByKhachThue_MaKhachAndDichVu_MadDichVuAndNgayBatDauBeforeAndNgayKetThucAfterAndMaHopDongDichVuNot(
